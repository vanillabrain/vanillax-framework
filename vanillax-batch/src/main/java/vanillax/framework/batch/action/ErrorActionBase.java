 ...
 */
public abstract class ErrorActionBase extends ActionBase implements IErrorAction {
    abstract public Object process(Object object, Throwable t) throws Exception;
}
