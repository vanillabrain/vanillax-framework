...
public class CallableStatementWrapper extends PreparedStatmentWrapper implements CallableStatement{
    private CallableStatement callableStatement;

    public CallableStatementWrapper(String sql, CallableStatement callableStatement) {
